        ...
        <section id="factTextArea">
          ...
          <section id="factPanel" class="col-md-2">
            ...
            <section id="tags" class="row">
              <div ng-repeat="tag in tags" class="row factTag"><span class="label label-default">{{ tag.tag_name }} <i ng-click="PinTag(tag)" class="fa fa-thumb-tack"></i> <i class="fa fa-search"></i> <i class="fa fa-play"></i> <i ng-click="deleteTag(tag)" class="fa fa-trash-o removeTagButton"></i></span></div>
            </section>
