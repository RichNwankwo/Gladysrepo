...
class FactInserted implements SelfHandling
{
    ...
    public function handle()
    {
        ...
        $questions =  [
                ...
                ['fact_id' => $fact_id, 'question_title' => 'How can you use this idea in relation to your strengths?', 'question_type' => 15],
                ...
                ['fact_id' => $fact_id, 'question_title' => 'If you discovered this idea for yourself, what would it be worth to everybody else?', 'question_type' => 25],
                ['fact_id' => $fact_id, 'question_title' => 'How can this idea be used to prepare for future?', 'question_type' => 26],
                ['fact_id' => $fact_id, 'question_title' => 'How can this idea be used to provide a better world?', 'question_type' => 27],
